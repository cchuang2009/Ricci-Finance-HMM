# Case Study — Semiconductor Rotation
...
How did network geometry, capital structure, and HMM regime behavior change during Semiconductor Rotation?

### 繁體中文

在半導體輪動期間，網路幾何、資金結構與 HMM 狀態如何改變？
